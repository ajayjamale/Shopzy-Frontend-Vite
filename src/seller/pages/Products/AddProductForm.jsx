              ...
              >
                ...
                <Typography
                  sx={{
                    fontWeight: 800,
                    fontSize: '1.2rem',
                    color: discountPreview > 0 ? 'success.main' : 'text.primary',
                  }}
                >
        ...
        <Stack spacing={2} sx={{ position: { lg: 'sticky' }, top: { lg: 90 } }}>
          ...
          <Paper sx={{ p: 2.2 }}>
            ...
            <Stack spacing={1}>
              ...
              <Row
                label="Price"
                value={formik.values.sellingPrice ? `Rs. ${formik.values.sellingPrice}` : '-'}
              />
              <Row
                label="MRP"
                value={formik.values.mrpPrice ? `Rs. ${formik.values.mrpPrice}` : '-'}
              />
