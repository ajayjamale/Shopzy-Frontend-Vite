...
const statusActions = ['PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', 'CANCELLED']
    ...
    <Box>
      ...
      {!data ? (
        <SellerEmptyState
          ...
          description={
            settlement.error || 'The requested settlement could not be loaded right now.'
          }
        />
      ) : (
        <>
          ...
          >
            <SellerSection
              ...
              action={
                <SellerStatusChip
                  label={humanizeSellerValue(data.settlementStatus)}
                  tone={toneForStatus(data.settlementStatus)}
                />
              }
            >
              ...
              <SellerKeyValue
                ...
                value={data.orderReference || 'Not provided'}
              />
            ...
            <SellerSection
              ...
              description="How the payout was derived from the order amount."
            >
              <SellerKeyValue label="Gross amount" value={formatSellerCurrency(data.grossAmount)} />
              <SellerKeyValue
                label="Commission"
                value={formatSellerCurrency(data.commissionAmount)}
              />
            ...
            <SellerSection
              ...
              description="Move the settlement into the next operational state when needed."
            >
