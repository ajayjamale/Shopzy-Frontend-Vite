      ...
      <Grid container spacing={3}>
        ...
        <Grid size={{ xs: 6 }}>
          <TextField
            ...
            onBlur={formik.handleBlur}
            error={
              formik.touched.pickupAddress?.pincode && Boolean(formik.errors.pickupAddress?.pincode)
            }
            helperText={
        ...
        <Grid size={{ xs: 12 }}>
          <TextField
            ...
            onBlur={formik.handleBlur}
            error={
              formik.touched.pickupAddress?.address && Boolean(formik.errors.pickupAddress?.address)
            }
            helperText={
        ...
        <Grid size={{ xs: 6 }}>
          <TextField
            ...
            onBlur={formik.handleBlur}
            error={
              formik.touched.pickupAddress?.state && Boolean(formik.errors.pickupAddress?.state)
            }
