    ...
    <div style={{ display: "grid", gap: 16 }}>
        ...
        <input
          ...
          onBlurCapture={(e) => {
            if (!emailTouched || validEmail) {
              ...
              e.currentTarget.style.boxShadow = emailTouched && !validEmail ? "0 0 0 3px rgba(180,35,24,0.16)" : "none";
            }
          }}
        />
      ...
      <button
        ...
        style={{
          ...
          gap: 8,
          cursor: loading || !email.trim() || (otpSent && otp.length !== 6) ? "not-allowed" : "pointer",
