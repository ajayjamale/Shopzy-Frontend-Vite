    ...
    return (
      <div className="amz-card">
        <div className="amz-empty-state">
          ...
          <p className="amz-empty-desc">Your order timeline will appear here once you make a purchase.</p>
          <a href="/" className="amz-btn-primary">Start shopping</a>
        </div>
      </div>
    );
  }
        ...
        <article className="amz-order-card" key={order.id}>
          <header className="amz-order-card-header">
            ...
            <div className="amz-order-meta">
              ...
              <span className="amz-order-meta-value">Rs. {order.totalSellingPrice?.toLocaleString("en-IN") || "-"}</span>
            </div>
