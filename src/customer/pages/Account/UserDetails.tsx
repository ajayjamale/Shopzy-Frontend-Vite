      ...
      <div className="amz-card">
        ...
        <div className="amz-card-body">
          <div className="flex items-center gap-4 mb-5">
            ...
            <div>
              <p className="text-lg font-semibold text-slate-900">{user.user?.fullName || "Shopzy User"}</p>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={label as string} className="surface-soft p-3" style={{ borderRadius: 14 }}>
                <p className="text-xs uppercase tracking-[0.12em] text-slate-500 font-bold">{label as string}</p>
                <p className="text-sm font-semibold text-slate-800 mt-1">{value as string}</p>
              </div>
            ))}
          </div>
        </div>
