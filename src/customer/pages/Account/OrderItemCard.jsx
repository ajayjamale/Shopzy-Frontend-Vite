...
const ReviewModal = ({ open, onClose, productId, productTitle, productImage, sellerName }) => {
          ...
          {reviewSuccess && submitted ? (
            ...
            >
              ...
              >
                ...
                <div>
                  {sellerName && (
                    <div style={{ fontSize: '0.75rem', color: '#64748B' }}>{sellerName}</div>
                  )}
                  <div
                    style={{
                      fontSize: '0.9375rem',
                  ...
                  <div style={{ display: 'flex', gap: 2, marginTop: 4 }}>
                    {[1, 2, 3, 4, 5].map((s) =>
                      s <= formik.values.reviewRating ? (
                        ...
                        <StarBorderIcon
                          key={s}
                          style={{ fontSize: '0.875rem', color: '#d5d9d9' }}
                        />
                      ),
                    )}
                  </div>
              ...
              <div style={{ fontSize: '0.8125rem', color: '#64748B' }}>Closing automatically…</div>
            </div>
          ) : (
            /* ════════════════ FORM ════════════════ */
            <form onSubmit={formik.handleSubmit} noValidate>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <textarea
                  ...
                  onBlur={(e) => {
                    formik.handleBlur(e)
                    onBlur(!!formik.errors.reviewText)(e)
                  }}
                  onFocus={onFocus}
                  placeholder="What did you like or dislike? What did you use this product for?"
                  style={{
                    ...inputBase(!!formik.touched.reviewText && !!formik.errors.reviewText),
                    resize: 'vertical',
                  }}
                />
                    ...
                    {uploadingImg ? (
                      <span
                        style={{
                          ...
                          borderTopColor: '#111',
                          borderRadius: '50%',
                          animation: 'amz-spin 0.7s linear infinite',
              ...
              >
                ...
                Focus on the product's features and your experience. Keep it helpful and relevant to
                other shoppers.
              </div>
          ...
          {isDelivered && (
            <div style={{ marginTop: 10, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              ...
              <button
                ...
                onClick={(e) => {
                  e.stopPropagation()
                  navigate(`/account/orders/${order.id}/${item.id}`)
                }}
              >
                View details
              </button>
        ...
        <div style={{ padding: '16px 18px', display: 'grid', gap: 12 }}>
          <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
            ...
            <div>
              ...
              {sellerName && (
                <div style={{ fontSize: 12, color: '#64748B' }}>Sold by {sellerName}</div>
              )}
            </div>
          </div>
          ...
          {formik.touched.reason && formik.errors.reason && (
            <span style={{ color: '#c40000', fontSize: 12 }}>{formik.errors.reason}</span>
          )}
          ...
          {formik.touched.description && formik.errors.description && (
            <span style={{ color: '#c40000', fontSize: 12 }}>{formik.errors.description}</span>
          )}
