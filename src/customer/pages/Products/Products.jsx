...
import { FormControl, MenuItem, Pagination, Select, useMediaQuery, useTheme } from '@mui/material'
  ...
  return (
    <div className="app-container py-7">
      <div className="mb-5">
        ...
        <h1 style={{ fontSize: 'clamp(1.7rem, 3vw, 2.4rem)', textTransform: 'capitalize' }}>
          {categoryLabel}
        </h1>
      ...
      <div className="grid lg:grid-cols-[280px_1fr] gap-5 items-start">
        {isDesktop ? (
          ...
          <div className="relative">
            <button onClick={() => setShowMobileFilter((v) => !v)} className="btn-secondary">
              {showMobileFilter ? (
        ...
        <div>
          <div
            className="surface p-3 sm:p-4 mb-4 flex items-center justify-between gap-3"
