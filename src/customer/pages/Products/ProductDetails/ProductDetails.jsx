        ...
        <div className="grid lg:grid-cols-[1fr_1fr] gap-7">
          ...
          <section className="grid gap-4 content-start">
            <p className="text-sm text-teal-700 font-semibold">
              {product.seller?.businessDetails?.businessName || 'Shopzy Seller'}
            </p>
            <h1 style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', lineHeight: 1.2 }}>
              {product.title}
            </h1>
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div
                className="surface-soft p-3 flex items-center gap-2"
            ...
            <Divider />
            <div>
              <h3 className="text-sm font-bold uppercase tracking-[0.11em] text-slate-500 mb-2">
                Description
              </h3>
