...
const fallbackCards = [
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=1200&q=80&fit=crop',
    target: 'women_western_wear',
  },
  {
    title: 'Tech Week Offers',
    subtitle: 'Latest gadgets at best prices',
    imageUrl: 'https://images.unsplash.com/photo-1518773553398-650c184e0bb3?w=1200&q=80&fit=crop',
    target: 'electronics',
  },
  {
    title: 'Home Upgrade Picks',
    subtitle: 'Refresh your living space',
    imageUrl: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=1200&q=80&fit=crop',
      ...
      <div className="grid md:grid-cols-3 gap-4 auto-rows-[190px]">
        {cards.slice(0, 3).map((card, index) => (
          <button
            ...
            className={`text-left relative overflow-hidden rounded-2xl border border-[#DCE8EC] group ${index === 0 ? 'md:col-span-2 md:row-span-2' : ''}`}
            style={{
              minHeight: 190,
              background: '#0F172A',
              width: '100%',
          ...
          >
            ...
            <div className="relative z-10 p-5 h-full flex flex-col justify-end">
              <p
                className={`text-white font-semibold leading-tight ${index === 0 ? 'text-2xl' : 'text-xl'}`}
              >
                {card.title}
              </p>
