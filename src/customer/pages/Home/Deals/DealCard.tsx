...
const DealCard = ({deal}:{deal:Deal}) => {
  ...
  return (
    <div onClick={()=>navigate(`/products/${categoryId}`)} className='w-full cursor-pointer'>
        <img className='border-x-[7px] border-t-[7px] border-pink-600 w-full h-[12rem] object-cover object-top' src={categoryImage} alt="" />
