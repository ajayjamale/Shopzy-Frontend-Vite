  ...
  return (
    <footer className="footer-shell">
      <div className="footer-top">
        <div>
          <button className="bg-transparent border-0 p-0 cursor-pointer" onClick={() => navigate("/")}> 
            <ShopzyLogo size={20} textColor="#F8FAFC" color="#ffffff" />
          </button>
          <p className="mt-4 text-sm leading-6" style={{ color: "#A8BCCB", maxWidth: 380 }}>
            Shopzy is a premium ecommerce experience built for discovery, trusted checkout,
            and delightful shopping journeys across fashion, electronics, and home.
          </p>
        ...
        <div>
          ...
          {["Help Center", "Shipping & Delivery", "Returns", "Order Tracking", "Contact"].map((item) => (
        ...
        <div>
          ...
          {subscribed ? (
            <div className="mt-3 px-3 py-2 rounded-xl text-sm font-semibold" style={{ background: "rgba(15,118,110,0.24)", color: "#9EE7DF" }}>
              You are subscribed.
            </div>
          ) : (
