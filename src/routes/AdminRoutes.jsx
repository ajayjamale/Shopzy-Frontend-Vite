...
import Deal from '../admin/pages/home-content/Deal'
...
import HomeContentManager from '../admin/pages/home-content/HomeContentManager'
...
const AdminRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="add-coupon" element={<Navigate to="/admin/coupon?view=create" replace />} />
