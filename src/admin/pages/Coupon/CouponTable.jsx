...
export default function CouponTable() {
  ...
  const allCoupons = adminCoupon?.coupons ?? []
    ...
    <Box>
      ...
      <Box sx={{ display: 'flex', gap: 2, mb: 2.5, flexWrap: 'wrap' }}>
        {[
          ...
          {
            label: 'Inactive',
            value: allCoupons.length - activeCoupons,
            color: '#CC0C39',
            bg: '#fff5f7',
          },
        ].map((stat) => (
      ...
      >
        ...
        {!adminCoupon?.loading && filteredCoupons.length === 0 && (
          <Box sx={{ textAlign: 'center', py: 7, color: '#64748B' }}>
            ...
            <Typography
              sx={{ fontFamily: '"Manrope", Arial, sans-serif', fontSize: 14, fontWeight: 600 }}
            >
              No coupons found
            </Typography>
            <Typography
      ...
      >
        ...
        <DialogContent sx={{ pt: 2.5 }}>
          <DialogContentText
            sx={{ fontFamily: '"Manrope", Arial, sans-serif', fontSize: 13, color: '#0F172A' }}
          >
